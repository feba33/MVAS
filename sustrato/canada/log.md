# Registro de canada (log.md)

Registro cronológico **append-only** de la entidad `canada`.
Prefijo: `## [YYYY-MM-DD] <tipo> | <título>` (parseable: `grep "^## \[" log.md`).

## [2026-07-09] setup | Nodo wiki de canada
- Creada la superstructura recursiva de la entidad `canada` dentro de `sustrato/`:
  `raw/`, `index.md`, `log.md` y `README.md`.
- Demuestra el principio: toda la info de canada vive solo en esta carpeta.
...
## [2026-07-12] ingest | Educación en Canadá (jurisdicción provincial, PSE pública)
- Fuentes: Wikipedia (en) — Education in Canada; Canada.ca (student financial aid) — reference-only.
- Página: `educacion.md`. Educación es competencia provincial (s.93 Constitución 1867), no federal; currículo por provincia. Público, financiado por federal/provincial/local. Niveles: primaria, secundaria, post-secundaria (varía por provincia; Québec CEGEP). Bilingüe EN/FR (New Brunswick oficialmente bilingüe; derechos minoría-lengua s.23 Carta). PSE: universidades casi todas públicas (Laval 1663 la más antigua; U of T >85k la mayor; U of T/UBC/McGill/McMaster top-100); colleges técnicos. OCDE 2022: país más educado (>57% adultos con terciario); ~5.3% PIB. Student aid: provincial + Canada Student Grants/Loans (ESDC). Cross-ref dominio/educacion, provincial-federal, recursos-naturales.

## [2026-07-12] ingest | Política monetaria Canadá (Bank of Canada, tasa de política, inflation targeting)
- Fuentes: Bank of Canada (bankofcanada.ca/core-functions/monetary-policy); Wikipedia (en) — Bank of Canada — reference-only.
- Página: `politica-monetaria.md`. BoC (1934, Crown corp; nacionalizada 1938) banco central; mandato valor del dinero vía inflation targeting 2% (CPI, acuerdo Min. Finanzas 1991); Governing Council fija overnight/policy rate; independencia operativa; coordinación con Finanzas/OSFI. Cross-ref dominio/economia, dominio/banca, sustrato/estados-unidos/politica-monetaria, sustrato/canada/sector-bancario.
